...
mod tests {
    ...
    #[test]
    fn test_days_into_millisceonds() {
        assert_eq!(86400000, into_milliseconds("1d"))
    }

    #[test]
    fn test_hours_into_millisceonds() {
        assert_eq!(7200000, into_milliseconds("2h"))
    }

    #[test]
    fn test_minutes_into_millisceonds() {
        assert_eq!(300000, into_milliseconds("5m"))
    }

    #[test]
    fn test_seconds_into_millisceonds() {
        assert_eq!(100000, into_milliseconds("10s"))
    }

    #[test]
    fn test_millisceonds() {
